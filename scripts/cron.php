...
foreach($rivers AS $river) {
  file_put_contents($jsonPath . '/' . $river . '.json', json_encode(json_decode(file_get_contents('http://210.61.23.112/tainanwatermobile/TainanLocalWst/GetLocalWstWarnInfo3.aspx?basin=' . $river)), JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
}
